...
export class ExperianceColumnAddedInEmployee1691393154776 implements MigrationInterface {
    name = 'ExperianceColumnAddedInEmployee1691393154776'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "employee" ADD "experiance" integer NOT NULL`);
